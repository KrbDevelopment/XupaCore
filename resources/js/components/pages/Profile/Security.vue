...
<div class="w-full relative shadow-2xl rounded overflow-hidden bg-white">
    ...
    <div class="w-full grid grid-cols-12">
        ...
        <div class="col-span-12 h-full pb-12 md:col-span-10">
            <div class="px-4 pt-4">
                <form action="#" class="flex flex-col space-y-7" @submit.prevent="performChangePasswordAttempt">
                    ...
                    <div class="content-center w-full xl:w-3/4">
                        ...
                        <div class="relative mt-1">
                            <input
                                ...
                                type="text" placeholder="Enter your current Password" v-model="current_password">
                        </div>
                    </div>
                    ...
                    <div class="content-center w-full xl:w-3/4">
                        ...
                        <div class="relative mt-1">
                            <input
                                class="w-full content-center text-base px-4 py-2 border-b rounded-xl border-gray-300 focus:border-xupa focus:outline-none focus:ring-0"
                                type="text" placeholder="Enter your new Password" v-model="password">
                        </div>
                    ...
                    <div class="content-center w-full xl:w-3/4">
                        ...
                        <div class="relative mt-1">
                            <input
                                class="w-full content-center text-base px-4 py-2 border-b rounded-xl border-gray-300 focus:border-xupa focus:outline-none focus:ring-0"
                                type="text" placeholder="Enter your new Password again" v-model="confirm_password">
                        </div>
                    </div>
