...
import { CheckIcon, ThumbUpIcon, UserIcon, PlayIcon, DotsHorizontalIcon, CheckCircleIcon, XCircleIcon, ChevronRightIcon, CollectionIcon } from '@heroicons/vue/solid'
const tabs = [
