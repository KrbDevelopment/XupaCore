                            ...
                            <div class="w-full">
                                <div class="flex flex-col lg:flex-row mx-auto bg-white shadow rounded-lg">
                                    <div class="w-full lg:w-1/3 px-12 flex flex-col items-center py-10">
                                        ...
                                        <button type="submit" class="ml-3 inline-flex w-full justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-xupa hover:bg-xupa-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-xupa" @click="sendResetPasswordNotification(account)">
                                            Send Notification
                                        </button>
                                    </div>
                                    <div class="w-full lg:w-1/3 px-12 flex flex-col items-center py-10 border-t border-b lg:border-t-0 lg:border-b-0 lg:border-l border-gray-300">
                                        ...
                                        <button type="submit" class="ml-3 inline-flex w-full justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-xupa hover:bg-xupa-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-xupa" @click="sendVerifyEmailNotification(account)">
                                            Send Notification
                                        </button>
                                    </div>
                                    <div class="w-full lg:w-1/3 px-12 flex flex-col items-center py-10 border-t border-b lg:border-t-0 lg:border-b-0 lg:border-l border-gray-300">
                                        ...
                                        <button type="submit" class="ml-3 inline-flex w-full justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-xupa hover:bg-xupa-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-xupa" @click="sendPasswordChangedNotification(account)">
                                            Send Notification
                                        </button>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        sendResetPasswordNotification(user) {
            ...
            Inertia.post(window.route('accounts.requests.account.notify.reset_password', { user: user }), {
        ...
        sendVerifyEmailNotification(user) {
            ...
            Inertia.post(window.route('accounts.requests.account.notify.verify_email', { user: user }), {
        ...
        sendPasswordChangedNotification(user) {
            ...
            Inertia.post(window.route('accounts.requests.account.notify.password_changed', { user: user }), {
